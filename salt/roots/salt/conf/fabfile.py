...
# Server paths
PROJECT_PATH = "{{ pillar['django']['path'] }}/{{ pillar['django']['projpath'] }}"

MANAGE_BIN = "{{ pillar['django']['path'] }}/{{ pillar['django']['projpath'] }}/manage.py"


def manage_py(command):
    """ Runs a manage.py command on the server """
    with cd("{{ pillar['django']['path'] }}/{{ pillar['django']['projpath'] }}"):
